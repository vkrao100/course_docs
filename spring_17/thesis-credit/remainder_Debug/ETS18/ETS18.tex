...
\title{\Large\textsc{{R}esolving {U}nknown {C}omponent {I}n {F}inite {F}ield {A}rithmetic {C}ircuits {U}sing {C}omputer {A}lgebra {M}ethods}}
...
\input{preliminaries/prelim.tex}
\input{theory_procedure/theory_procedure.tex}
\input{experiments/experiments.tex}
\input{conclusion/limitations_conclusion.tex}
%%%%%%%%%%%%%%%%%%%% The bibliography %%%%%%%%%%%%%%%%%%%%%%%%%%%%
