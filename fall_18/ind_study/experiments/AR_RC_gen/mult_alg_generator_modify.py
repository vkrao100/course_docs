...
def recursive_stage_ppa_creator(stageIndex, multSize, oFile):
    ...
    #first carry in value is always zero at stage 1
        ...
        for fiIndex in range(rangeStart,int(multSize)):
            fiPpaPropOutput = os.path.join("-P"+str(stageIndex-1)+"X"+str(fiIndex)+" + "+"sp"+str(stageIndex-2)+"_"+str(fiIndex+1)+"+"+"s"+str(stageIndex-1)+"_"+str(fiIndex)+ "-2*" + "sp"+str(stageIndex-2)+"_"+str(fiIndex+1)+"*"+"s"+str(stageIndex-1)+"_"+str(fiIndex) +";")
        ...
        for productIndex in range(rangeStart+1,int(multSize)):
            productAssign = os.path.join("-sp"+str(stageIndex-1)+"_"+str(productIndex)+" + "+"P"+str(stageIndex-1)+"X"+str(productIndex)+"+"+"P"+str(stageIndex-1)+"C"+str(productIndex-1)+ "-2*" + "P"+str(stageIndex-1)+"X"+str(productIndex)+"*"+"P"+str(stageIndex-1)+"C"+str(productIndex-1) + ";")
